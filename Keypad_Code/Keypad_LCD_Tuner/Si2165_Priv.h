...
#define REG_LOCK_TIMEOUT1_LSB		0x00c4
#define REG_LOCK_TIMEOUT2		0x00c5
#define REG_LOCK_TIMEOUT3		0x00c6
#define REG_LOCK_TIMEOUT4_MSB		0x00c7

#define REG_AUTO_RESET			0x00cb
#define REG_OVERSAMP1_LSB		0x00e4
#define REG_OVERSAMP2		        0x00e5
#define REG_OVERSAMP3		        0x00e6
#define REG_OVERSAMP4_MSB		0x00e7

#define REG_IF_FREQ_SHIFT1_LSB		0x00e8
#define REG_IF_FREQ_SHIFT2		0x00e9
#define REG_IF_FREQ_SHIFT3		0x00eA
#define REG_IF_FREQ_SHIFT4_MSB		0x00eB

#define REG_DVB_STANDARD		0x00ec
#define REG_DSP_CLOCK			0x0104
#define REG_ADC_RI8			0x0123
#define REG_ADC_RI0                     0x0129
...
#define REG_ADDR_JUMP1_LSB		0x0348
#define REG_ADDR_JUMP2			0x0349
#define REG_ADDR_JUMP3			0x034A
#define REG_ADDR_JUMP4_MSB		0x034B
#define REG_UNKNOWN_350_1		0x0350
#define REG_UNKNOWN_350_2		0x0351
...
#define REG_TS_SLR1			0x04f4
#define REG_TS_SLR2			0x04f5
#define REG_TS_SLR3			0x04f6
#define REG_RSSI_ENABLE			0x0641
#define REG_RSSI_PAD_CTRL		0x0646
#define REG_TS_PARALLEL_MODE		0x08f8

#define PLL_ENABLE                      0x00A2
#define PLL_N_DIVIDER 			0x00A2
#define PLL_P_DIVIDER 			0x00A2
#define PLL_L_DIVIDER 			0x00A0
#define PLL_M_DIVIDER 			0x00A1
#define PLL_R_DIVIDER 			0x00A3
